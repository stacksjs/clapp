...
export default class Prompt {
  ...
  public state: PromptState = 'initial'
  public error = ''
  public value: any
   ...
   */
  private setSubscriber<T extends keyof PromptEvents>(
    event: T,
    opts: { cb: PromptEvents[T], once?: boolean },
  ) {
   ...
   */
  public on<T extends keyof PromptEvents>(event: T, cb: PromptEvents[T]): void {
   ...
   * @param cb - The callback
   */
  public once<T extends keyof PromptEvents>(event: T, cb: PromptEvents[T]): void {
   ...
   */
  public emit<T extends keyof PromptEvents>(event: T, ...data: Parameters<PromptEvents[T]>): void {
